module FL {
     ...
     * @Version: V1.0
     */
    export class ReqLoadingViewServer extends BaseView {

        private static _only:ReqLoadingViewServer;
        ...
        public static getInstance(): ReqLoadingViewServer {
            if (!this._only) {
                this._only = new ReqLoadingViewServer();
            }
        ...
        protected onAddToStagexxx():void {
            ...
            // }
            egret.log("# ReqLoadingViewServer onAddToStagexxx");
        }
        ...
        protected onRemovedFromStagexxx():void {
            ...
            // }
            // MvcUtil.delView(this._transparentMask);
            egret.log("# ReqLoadingViewServer onRemovedFromStagexxx");
        }
