module FL {
    /** 茶楼战绩---今日战榜页面 */
    export class TeaHouseLogTodayRankingView extends TeaHouseLogCommonView {
        ...
        protected initView() {
            ...
            TeaHouseMsgHandle.sendRankingListMsg(ShowTeaHouseWarsListMsg.WARS_LIST_FOR_TODAY);
        }
    }
}