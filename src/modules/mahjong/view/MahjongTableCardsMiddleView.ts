module FL {
    ...
    /**
     * 深圳市天天爱科技有限公司 版权所有
     * @Name:  MahjongBase - MahjongTableCardsMiddleView
     * @Description:  //牌桌显示牌中间区域，包括牌桌四家已经打出的牌和刚打出牌的箭头，和我要打牌提示已经出了几张，还有癞子也放到这里
     * @Create: DerekWu on 2017/11/23 9:20
     * @Version: V1.0
     */
    export class MahjongTableCardsMiddleView extends eui.Group {

        /** 单例 */
        private static _onlyOne:MahjongTableCardsMiddleView;

        //调停者名字，删除界面的时候会自动移除
        public readonly mediatorName: string = MahjongTableCardsMiddleViewMediator.NAME;
        //界面层级，UI框架自动管理
        ...
        /** 调停者 */
        private _mediator:MahjongTableCardsMiddleViewMediator;
        ...
        private constructor() {
            ...
            self._mediator = new MahjongTableCardsMiddleViewMediator(self);
        }

        public static getInstance():MahjongTableCardsMiddleView {
            if (!this._onlyOne) {
                this._onlyOne = new MahjongTableCardsMiddleView();
            }
