module FL {
    /**
     * 深圳市天天爱科技有限公司 版权所有
     * @Name:  MahjongBase - MD5
     * @Description:  MD5加密
     * @Create: ArielLiang on 2018/1/31 16:38
     * @Version: V1.0
     */
    export class MD5 {
        /*
        ...
        */
        ...
        private hexcase:number = 0;   /* hex output format. 0 - lowercase; 1 - uppercase        */
        private b64pad:string = "";  /* base-64 pad character. "=" for strict RFC compliance   */
